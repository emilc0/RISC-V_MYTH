...
\TLV
   ...
   |cpu
      @0
         ...
         ?$valid
            $pc[31:0] = >>1$reset? '0 : !$valid? >>1$pc : >>3$valid_taken_br? >>3$br_tgt_pc[31:0] : >>3$inc_pc[31:0];
         $imem_rd_en = !$reset && $valid;
      ...
      @3
         ...
         $rf_wr_data[31:0] = $is_jal ? $inc_pc[31:0]: $result[31:0];
