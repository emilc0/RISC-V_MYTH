...
\TLV
   ...
   |cpu
      ...
      @1
         ...
         $is_jal   = $dec_bits[10:0] ==? 11'bx_xxx_1101111; //2 jumps
         $is_jalr  = $dec_bits[10:0] ==? 11'bx_000_1100111;
         
         $is_lb    = $dec_bits[10:0] ==? 11'bx_000_0000011; //5 loads
         $is_lh    = $dec_bits[10:0] ==? 11'bx_001_0000011;
         $is_lw    = $dec_bits[10:0] ==? 11'bx_010_0000011;
         $is_lbu   = $dec_bits[10:0] ==? 11'bx_100_0000011;
         $is_lhu   = $dec_bits[10:0] ==? 11'bx_101_0000011;
         
         $is_sb    = $dec_bits[10:0] ==? 11'bx_000_0100011; //3 store
      ...
      @4
         ...
         $dmem_rd_en = $is_load;
         //$dmem_rd_index[5:0] = $dmem_addr; //no need
   ...
   *passed = |cpu/xreg[15]>>20$value == (1+2+3+4+5+6+7+8+9);
   *failed = 1'b0;
